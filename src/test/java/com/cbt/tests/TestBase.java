...
//    Object that takes notes and saves then in the report
...
//	    get screenshot using the utility method and save the location of screenshot
	   String screenshotLocation =  BrowserUtils.getScreenshot(result.getName());
	   
	   
	// if it fails --> it will capture the name of method
